...
La siguiente aplicacion fue creada en lenguaje Golang. Esta se divide en 2 Carpetas: Backend y Frontend, y comenzaremos visualizando la clase main que es en la cual esta todo el nucleo del proyecto. (al menos del Backend)

### go.mod

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/3e7040fb-5cdf-46dc-9f06-7fdc5f7061e8)
...
Luego de esto, como dicho proyecto llevara el uso de Fiber utilizamos el siguiente comando descargarlo y usarlo en nuestro proyecto;


**go get github.com/gofiber/fiber/v2**

 y nos creara un archivo llamado go.sum para todas las dependencias de fiber

 ![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/dda83341-506f-47fe-8d8a-5ea4b1a9fe11)
...
![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/4fac692d-b9c5-4e0f-bd6b-2289fad1fe15)

**package main:** Indica que este archivo es el punto de entrada del programa.

**Importaciones:** Se importan los paquetes necesarios, que contienen definiciones y funcionalidades utilizadas en el programa.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/e4beba2c-4d9f-49f4-bbcf-19e70b43fd1c)


**Variables Globales:** Se declaran variables globales que se utilizarán en todo el programa. Estas variables son instancias de estructuras de datos como **TablaHash, ListaSimple, ArbolB, Grafo y ArbolMerkle.**

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/8302fd16-b852-4298-8c25-787e2c21616d)

**Función main():** Es la función principal que se ejecuta al iniciar el programa.

**Inicialización de variables globales:** Se crean instancias de las variables globales.

**Configuración de Fiber:** Se crea una nueva instancia de la aplicación Fiber y se configuran los middleware.

**Definición de rutas y manejo de peticiones:** Se definen las rutas y se asocian con funciones específicas que manejarán las peticiones HTTP.

**Inicio del servidor:** La aplicación comienza a escuchar en el puerto 4000.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/fa3b74ee-a9c1-4e39-9ec2-64010228241f)

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/1ea2d802-c7f0-4f21-8547-90891b64b4fd)

**Función Validar:** Maneja la validación de credenciales de usuario. 

-> Se parsea el cuerpo de la solicitud para obtener la información del usuario.

-> Se verifica si las credenciales corresponden al usuario **ADMIN_201712620** y se devuelve un JSON con el resultado.

-> Si no es el usuario administrador, se verifica en el árbol B de tutores y la tabla hash de alumnos, retornando el resultado en un JSON.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/c75909d9-3798-43a7-a325-ba1968207c50)

**Función RegistrarAlumno:** Maneja el registro de un nuevo alumno.

-> Se parsea el cuerpo de la solicitud para obtener la información del alumno.

-> Se inserta el alumno en la tabla hash de alumnos.

-> Se devuelve un JSON con el resultado del registro y la tabla de alumnos actualizada.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/f679ec28-fc18-49fc-b38a-1bba10ef1a44)

**Función RegistrarTutor:** Maneja el registro de un nuevo tutor.

-> Se parsea el cuerpo de la solicitud para obtener la información del tutor.

-> Se inserta el tutor en el árbol B de tutores.

-> Se devuelve un JSON con el resultado del registro.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/dc53b838-199f-4c04-ad75-1c2b9317b6d4)

**Función SHA256:** Genera un hash SHA256 de una cadena.

-> Se crea un nuevo hash SHA256 y se escribe la cadena en él.

-> El resultado se convierte a formato hexadecimal.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/297095b8-db2a-4eb2-9f2f-7d09dd0f6888)

**Función TablaAlumnos:** Devuelve la información de la tabla de alumnos en formato JSON.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/82ea1dd7-dfa8-45c9-94c0-a19ceefbe342)

**Función RegistrarCursos:** Maneja el registro de cursos.

-> Se parsea el cuerpo de la solicitud para obtener la información de los cursos.

-> Se recorre la lista de cursos y se insertan en el grafo de cursos.

-> Se devuelve un JSON con el resultado del registro.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/5f39ab0e-1b6f-4e64-b4a9-716ff17cb3a7)

**Función GuardarLibro:** Maneja el registro de libros.

-> Se parsea el cuerpo de la solicitud para obtener la información del libro.

-> Se guarda el libro en el árbol B de tutores.

-> Se devuelve un JSON con el resultado del registro.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/a676a371-aaba-4459-8c20-08d4eed8a881)

**Función ObtenerLibrosAdmin:** Obtiene la lista de libros disponibles para administradores.

-> Se utiliza una lista temporal para almacenar la información de libros.

-> Se recorre la lista de tutores para obtener los libros disponibles.

-> Se devuelve un JSON con la lista de libros.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/0f2d5cdf-6af6-478f-96c1-299750f60e6f)

**Función GuardarPublicacion:** Maneja el registro de publicaciones.

-> Se parsea el cuerpo de la solicitud para obtener la información de la publicación.

-> Se guarda la publicación en el árbol B de tutores.

-> Se devuelve un JSON con el resultado del registro.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/a3be8dac-98b3-491c-a9ec-90186aa19361)

**Función RegistrarDecision:** Maneja el registro de decisiones sobre libros.

-> Se parsea el cuerpo de la solicitud para obtener la información de la decisión.

-> Se agrega un bloque al árbol Merkle para auditar la decisión.

-> Se actualiza el estado del libro en el árbol B de tutores.

-> Se devuelve un JSON con el resultado del registro.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/23390f86-397b-482d-99a9-f9f9b8e6fc82)

**Función CursosAlumnos:** Obtiene los cursos de un alumno.

-> Se parsea el cuerpo de la solicitud para obtener la información del alumno.

-> Se busca al alumno en la tabla hash y se devuelve un JSON con los cursos asociados.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/922d6360-a7ed-4f7e-a145-29ee87f83c4e)

**Función ReporteArbolB:** Genera un reporte gráfico del árbol B de tutores.

-> Se especifica la ruta y nombre del archivo de imagen.

-> Se invoca la función para graficar el árbol B.

-> Se lee el archivo de imagen y se convierte a base64.

-> Se devuelve un JSON con el resultado del proceso y la imagen en formato base64.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/a5551adc-11e0-4375-a0cb-eaa4fa9fd4fe)


**Función ReporteGrafo:** Genera un reporte gráfico del grafo de cursos.

-> Se especifica la ruta y nombre del archivo de imagen.

-> Se invoca la función para generar el reporte del grafo.

-> Se lee el archivo de imagen y se convierte a base64.

-> Se devuelve un JSON con el resultado del proceso y la imagen en formato base64.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/0f411b26-fcad-41da-b00c-f106e45dbcf7)


**Función ReporteMerkle:** Genera un reporte gráfico del árbol Merkle.

-> Se especifica la ruta y nombre del archivo de imagen.

-> Se invoca la función para graficar el árbol Merkle.

-> Se lee el archivo de imagen y se convierte a base64.

-> Se devuelve un JSON con el resultado del proceso y la imagen en formato base64.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/967212ab-dfa9-4b48-b28d-6906f731b4ab)


**Función ObetnerLibrosAlumno:** Obtiene la lista de libros entregados a un alumno.

-> Se utiliza una lista temporal para almacenar la información de libros.

-> Se recorre la lista de tutores para obtener los libros entregados a un alumno.

-> Se devuelve un JSON con la lista de libros.

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/00ecf0ba-08d8-4919-9bba-9250b61e7d9d)


**Función ObetnerPublicacionessAlumno:** Obtiene la lista de publicaciones de un alumno.

-> Se utiliza una lista temporal para almacenar la información de las publicaciones.

-> Se recorre la lista de tutores para obtener las public

![image](https://github.com/AndresCalvo98/EDD_VD2S2023_PY_201712620/assets/66381259/a66f31d6-768a-4254-96e1-85daf5e634d4)

**Función FinalizarLibros:** Finaliza la generación del árbol Merkle con los bloques actuales.

-> Invoca la función para generar el árbol Merkle con los bloques existentes.

-> Devuelve un JSON con el resultado del proceso.
...
**NodoLista:** Representa un nodo en la lista simple.

**Tutor:** Es un puntero al nodo correspondiente en el árbol B.
...
**ListaSimple:** Representa la lista simple.

**Inicio:** Es un puntero al primer nodo en la lista.
...
**Insertar:** Este método permite agregar un nuevo nodo a la lista.

-> Si la lista está vacía (Longitud == 0), se crea un nuevo nodo (NodoLista) con el tutor proporcionado y se establece como el inicio de la lista.

-> Si la lista no está vacía, se recorre la lista hasta llegar al último nodo y se agrega un nuevo nodo al final de la lista.
